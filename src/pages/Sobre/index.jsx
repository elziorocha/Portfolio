...
import { FaHtml5, FaCss3Alt, FaJs, FaReact, FaAngular, FaNodeJs, FaDatabase, FaPhp, } from "react-icons/fa6";
import { BiLogoFirebase, BiLogoRedux, BiLogoMongodb } from "react-icons/bi";
    ...
    <div className='background_sobre'>
      ...
      <div className="sobre_caixa">
        ...
        <div className='icons'>
          ...
          <FaJs className='js' /> <FaReact className='react' /> <BiLogoRedux className="redux" />  <FaAngular className='angular' />
          <br /> <FaNodeJs className='node' /> <BiLogoFirebase className='firebase' /> <FaDatabase className='dados' />
          <BiLogoMongodb className="mongo" /><FaPhp className='php' />
        </div>
      </div>
